...
colors <- c(
      "Vascular stabilization and maturation" = "#FF6B6B",
      "ECM and endothelial permeability" = "#4ECDC4",
      "Endothelial proliferation and survival" = "#45B7D1",
      "Vascular invasion and sprouting" = "#FFA07A",
      "Vascular remodelling and patterning" = "#98D8C8",
      "Hypoxia-induced angiogenesis" = "#FFD700"
    )

(ggplot(test_data, aes(x = stage, y = fold, color = fx, shape = effect)) 
