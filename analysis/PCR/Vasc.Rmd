...
heatmap_plot <- make_heatmap(heatmap_data, xaxis = "gene", facet = "stage") + 
...
heatmap_plot_effect <- make_heatmap(heatmap_data_effect, xaxis = "abb", facet = "stage") + 
  labs(x = "Function", caption = "➕ Positive effect | ➖ Negative effect") + 
  theme(plot.caption = element_text(hjust = 0.5, vjust = 0.5, face = "bold", size = 16))

save_png(heatmap_plot_effect, "vasc_heatmap_effect", subfolder = "PCR", height = 9, width = 20)
```
