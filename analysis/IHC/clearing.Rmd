...
purrr::walk(
    c("P4"),
    \(facet) make_signif_boxplot_inter(
        mod_vol_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage",
        ncol = 5, only_signif = FALSE, save_to_subfolder = "IHC", only_facets = facet
    )
)

# make_signif_boxplot_inter(
#     mod_vol_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage",
#     ncol = 5, only_signif = FALSE, save_to_subfolder = "IHC", only_facets = c("P8", "P12")
# )
```
...
make_signif_boxplot_inter(
    ...
    ncol = 5, only_signif = TRUE, save_to_subfolder = "IHC"
)
```
