...
mod_length_gamma_tot <- glmmTMB(
  network_length ~ condition * stage + offset(log(cerebellar_volume)) + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_area_gamma_tot <- glmmTMB(
  surface_area ~ condition * stage + offset(log(cerebellar_volume)) + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_seg_vol_gamma_tot <- glmmTMB(
  mean_segment_volume ~ condition * stage + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_seg_length_gamma_tot <- glmmTMB(
  mean_segment_length ~ condition * stage + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_seg_area_gamma_tot <- glmmTMB(
  mean_segment_surface_area ~ condition * stage + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_seg_part_gamma_tot <- glmmTMB(
  segment_partitioning ~ condition * stage + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_seg_rad_gamma_tot <- glmmTMB(
  mean_segment_radius ~ condition * stage + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_seg_tort_gamma_tot <- glmmTMB(
  mean_segment_tortuosity ~ condition * stage + (1 | mouse),
  family = Gamma("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_numbranch_nbinom_tot <- glmmTMB(
  branchpoints ~ condition * stage + offset(log(cerebellar_volume)) + (1 | mouse),
  family = nbinom1("log"),
  data = clearing_total,
  REML = TRUE
)
...
mod_numends_nbinom_tot <- glmmTMB(
  endpoints ~ condition * stage + offset(log(cerebellar_volume)) + (1 | mouse),
  family = nbinom1("log"),
  data = clearing_total,
  REML = TRUE
)
