...
```{r}
mods <- all_mods |> filter(var_name == "volume", stage %in% c("P12", "P21"))

mods |> apply(1, function(x) parameters(x$mod))

mods |> apply(1, function(x) emmeans(x$mod, specs = "condition", type = "response") |> 
...
cli_h1("[Fitness]")
performance(mod_length_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_area_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_seg_vol_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_seg_length_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_seg_area_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_seg_part_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_seg_rad_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_seg_tort_gamma_tot)
```
...
cli_h1("[Fitness]")
performance(mod_numbranch_nbinom_tot)
cli_h1("[Dispersion]")
...
cli_h1("[Fitness]")
performance(mod_numends_nbinom_tot)
cli_h1("[Dispersion]")
...
cli_h1("[Fitness]")
performance(mod_length_gamma_ds)
```
...
make_signif_boxplot_inter(mod_length_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_length_gamma_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
make_signif_boxplot_inter(mod_area_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_area_gamma_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_seg_vol_gamma_ds)
```
...
make_signif_boxplot_inter(mod_seg_vol_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_seg_vol_gamma_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_seg_length_gamma_ds)
```
...
make_signif_boxplot_inter(mod_seg_length_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_seg_length_gamma_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_seg_area_gamma_ds)
```
...
make_signif_boxplot_inter(mod_seg_area_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_seg_area_gamma_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_seg_part_gamma_ds)
```
...
make_signif_boxplot_inter(mod_seg_part_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_seg_part_gamma_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_seg_rad_gamma_ds)
```
...
make_signif_boxplot_inter(mod_seg_rad_gamma_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_seg_rad_gamma_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_seg_tort_gamma_ds)
```
...
cli_h1("[Fitness]")
performance(mod_numseg_nbinom_ds)
cli_h1("[Dispersion]")
...
make_signif_boxplot_inter(mod_numseg_nbinom_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_numseg_nbinom_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_numbranch_nbinom_ds)
cli_h1("[Dispersion]")
...
make_signif_boxplot_inter(mod_numbranch_nbinom_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_numbranch_nbinom_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
...
cli_h1("[Fitness]")
performance(mod_numends_nbinom_ds)
cli_h1("[Dispersion]")
...
make_signif_boxplot_inter(mod_numends_nbinom_ds, pred1 = "condition", pred2 = "level", facet = "stage", ncol = 5) |> 
  save_png("mod_numends_nbinom_ds_inter", subfolder = "IHC", width = 14, height = 6)
```
