...
clearing <- load_clearing_data(responses = clearing_responses)

clearing_total <- clearing |> dplyr::filter(level == "Total")
clearing_ds <- clearing |> dplyr::filter(level != "Total")
```
...
```{r}
mod_vol_gamma_tot_dharma <- DHARMa::simulateResiduals(
    mod_vol_gamma_tot,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
parameters(
    mod_vol_gamma_tot,
    exponentiate = should_exp(mod_vol_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_vol_gamma_tot),
    dvs = find_response(mod_vol_gamma_tot),
...
```{r}
mod_length_gamma_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_length_gamma_tot,
    exponentiate = should_exp(mod_length_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_length_gamma_tot),
    dvs = find_response(mod_length_gamma_tot),
    between = c("condition", "stage")
)
...
```{r}
mod_area_gamma_tot_dharma <- DHARMa::simulateResiduals(
    mod_area_gamma_tot,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
parameters(
    mod_area_gamma_tot,
    exponentiate = should_exp(mod_area_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_area_gamma_tot),
    dvs = find_response(mod_area_gamma_tot),
    between = c("condition", "stage")
)
...
```{r}
mod_seg_vol_gamma_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_vol_gamma_tot,
    exponentiate = should_exp(mod_seg_vol_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_vol_gamma_tot),
    dvs = find_response(mod_seg_vol_gamma_tot),
    between = c("condition", "stage")
)
...
```{r}
mod_seg_length_gamma_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_length_gamma_tot,
    exponentiate = should_exp(mod_seg_length_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_length_gamma_tot),
    dvs = find_response(mod_seg_length_gamma_tot),
    between = "condition"
)
...
```{r}
mod_seg_area_gamma_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_area_gamma_tot,
    exponentiate = should_exp(mod_seg_area_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_area_gamma_tot),
    dvs = find_response(mod_seg_area_gamma_tot),
    between = "condition"
)
...
```{r}
mod_seg_part_gamma_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_part_gamma_tot,
    exponentiate = should_exp(mod_seg_part_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_part_gamma_tot),
    dvs = find_response(mod_seg_part_gamma_tot),
    between = "condition"
)
...
```{r}
mod_seg_rad_gamma_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_rad_gamma_tot,
    exponentiate = should_exp(mod_seg_rad_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_rad_gamma_tot),
    dvs = find_response(mod_seg_rad_gamma_tot),
    between = c("condition", "stage")
)
...
```{r}
mod_seg_tort_gamma_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_tort_gamma_tot,
    exponentiate = should_exp(mod_seg_tort_gamma_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_tort_gamma_tot),
    dvs = find_response(mod_seg_tort_gamma_tot),
    between = "condition"
)
...
```{r}
mod_numseg_nbinom_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_numseg_nbinom_tot,
    exponentiate = should_exp(mod_numseg_nbinom_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_numseg_nbinom_tot),
    dvs = find_response(mod_numseg_nbinom_tot),
    between = c("condition", "stage")
)
...
```{r}
mod_numbranch_nbinom_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_numbranch_nbinom_tot,
    exponentiate = should_exp(mod_numbranch_nbinom_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_numbranch_nbinom_tot),
    dvs = find_response(mod_numbranch_nbinom_tot),
    between = "condition"
)
...
```{r}
mod_numends_nbinom_tot_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_numends_nbinom_tot,
    exponentiate = should_exp(mod_numends_nbinom_tot),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_numends_nbinom_tot),
    dvs = find_response(mod_numends_nbinom_tot),
    between = "condition"
)
...
parameters(
    mod_vol_gamma_ds,
    exponentiate = should_exp(mod_vol_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_vol_gamma_ds),
    dvs = find_response(mod_vol_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_length_gamma_ds_dharma <- DHARMa::simulateResiduals(
    mod_length_gamma_ds,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
parameters(
    mod_length_gamma_ds,
    exponentiate = should_exp(mod_length_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_length_gamma_ds),
    dvs = find_response(mod_length_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_area_gamma_ds_dharma <- DHARMa::simulateResiduals(
    mod_area_gamma_ds,
    plot = FALSE,
    n = 300,
    seed = getOption("seed")
...
parameters(
    mod_area_gamma_ds,
    exponentiate = should_exp(mod_area_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_area_gamma_ds),
    dvs = find_response(mod_area_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_seg_vol_gamma_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_vol_gamma_ds,
    exponentiate = should_exp(mod_seg_vol_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_vol_gamma_ds),
    dvs = find_response(mod_seg_vol_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_seg_length_gamma_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_length_gamma_ds,
    exponentiate = should_exp(mod_seg_length_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_length_gamma_ds),
    dvs = find_response(mod_seg_length_gamma_ds),
    between = "condition"
)
...
```{r}
mod_seg_area_gamma_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_area_gamma_ds,
    exponentiate = should_exp(mod_seg_area_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_area_gamma_ds),
    dvs = find_response(mod_seg_area_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_seg_part_gamma_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_part_gamma_ds,
    exponentiate = should_exp(mod_seg_part_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_part_gamma_ds),
    dvs = find_response(mod_seg_part_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_seg_rad_gamma_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_rad_gamma_ds,
    exponentiate = should_exp(mod_seg_rad_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_rad_gamma_ds),
    dvs = find_response(mod_seg_rad_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_seg_tort_gamma_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_seg_tort_gamma_ds,
    exponentiate = should_exp(mod_seg_tort_gamma_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_seg_tort_gamma_ds),
    dvs = find_response(mod_seg_tort_gamma_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_numseg_nbinom_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_numseg_nbinom_ds,
    exponentiate = should_exp(mod_numseg_nbinom_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_numseg_nbinom_ds),
    dvs = find_response(mod_numseg_nbinom_ds),
    between = c("condition", "stage", "level")
)
...
```{r}
mod_numbranch_nbinom_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_numbranch_nbinom_ds,
    exponentiate = should_exp(mod_numbranch_nbinom_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_numbranch_nbinom_ds),
    dvs = find_response(mod_numbranch_nbinom_ds),
    between = "condition"
)
...
```{r}
mod_numends_nbinom_ds_dharma <- DHARMa::simulateResiduals(
...
parameters(
    mod_numends_nbinom_ds,
    exponentiate = should_exp(mod_numends_nbinom_ds),
    ci_method = "wald",
    p_adjust = "none",
    summary = TRUE,
    digits = 3
...
distribution_summary(
    get_data(mod_numends_nbinom_ds),
    dvs = find_response(mod_numends_nbinom_ds),
    between = c("condition", "stage", "level")
)
